...
void ViewYmlDisplay::setupQuadraticDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupSimpleDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupSincScatterDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupScatterStyleDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupLineStyleDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupScatterPixmapDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupDateDemo(QCustomPlot *customPlot)
{
    demoName = "Date Demo";
...
void ViewYmlDisplay::setupTextureBrushDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupMultiAxisDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupLogarithmicDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupRealtimeDataDemo(QCustomPlot *customPlot)
{
    ...
    */
    ...
    // setup a timer that repeatedly calls ViewYmlDisplay::realtimeDataSlot:
    connect(&dataTimer, SIGNAL(timeout()), this, SLOT(realtimeDataSlot()));
    dataTimer.start(0); // Interval 0 means to refresh as fast as possible
}

void ViewYmlDisplay::setupParametricCurveDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupBarChartDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupStatisticalDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupSimpleItemDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupItemDemo(QCustomPlot *customPlot)
{
    demoName = "Item Demo";
    ...
    // setup a timer that repeatedly calls ViewYmlDisplay::bracketDataSlot:
    connect(&dataTimer, SIGNAL(timeout()), this, SLOT(bracketDataSlot()));
    dataTimer.start(0); // Interval 0 means to refresh as fast as possible
}

void ViewYmlDisplay::setupStyledDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupAdvancedAxesDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupColorMapDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupFinancialDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::setupPolarPlotDemo(QCustomPlot *customPlot)
{
...
void ViewYmlDisplay::Widgets()
{
    ...
    widQcp = new QWidget;
    widQcp->setMinimumSize(QSize(512, 512));
}

void ViewYmlDisplay::interactWaferMap(QCustomPlot *qcp)
{
    qcp->xAxis->setRange(-1, 1);
    qcp->yAxis->setRange(-1, 1);
    // qcp->xAxis->setVisible(false);

    wafer = new QCPItemEllipse(qcp);
    wafer->setPen(QPen(Qt::black));
    wafer->setBrush(QBrush(Qt::white));
    wafer->topLeft->setCoords(-1, -1);
    wafer->bottomRight->setCoords(1, 1);

    rect1 = new QCPItemRect(qcp);
    rect1->setPen(QPen(Qt::red));
    rect1->setBrush(QBrush(Qt::red));
    rect1->topLeft->setCoords(-0.5, -0.5);
    rect1->bottomRight->setCoords(0, 0);
    // connect(qcp, SIGNAL(mousePress(QMouseEvent*)), this, SLOT(handleQcpPress(QMouseEvent*)));
...
void ViewYmlDisplay::overlapWaferMapAndContour(QCustomPlot* qcp)
{
    ...
    qcp->xAxis2->setRange(-3, 3);
    qcp->yAxis2->setRange(-3, 3);

    // Create and add ellipse and rectangle to Graph 0
    QCPItemEllipse *ellipseItem = new QCPItemEllipse(qcp);
    ellipseItem->setPen(QPen(Qt::black));           // Set pen for both outline and fill
    ellipseItem->setBrush(QBrush(Qt::transparent)); // Make the fill transparent
    ellipseItem->topLeft->setCoords(-3, -3);
    ellipseItem->bottomRight->setCoords(3, 3);

    rectItem = new QCPItemRect(qcp);
    rectItem->setPen(QPen(Qt::red));
    QColor color(Qt::white);
    color.setAlpha(32);
    QBrush brush(color);
    rectItem->setBrush(brush);
    rectItem->topLeft->setCoords(-1, -1);
...
void ViewYmlDisplay::Layouts()
{
    ...
    vlytMain->setContentsMargins(0, 0, 0, 0);
    {
        ...
        spltMain->addWidget(cbb);
        spltMain->addWidget(widQcp);
    }

    vlytMain->addWidget(spltMain);
    setLayout(vlytMain);

    qcp = new QCustomPlot(widQcp);
...
void ViewYmlDisplay::handleQcpItemClick(QCPAbstractItem *item, QMouseEvent *event)
{
    ...
    printf("click %f, %f\n", x, y);
    // QPointF scenePos = qcp->mapToScene(event->pos());
    if (item == wafer)
    {
        printf("wafer\n");
    }
...
void ViewYmlDisplay::handleQcpPress(QMouseEvent *event)
{
    printf("qq");
}

void ViewYmlDisplay::onComboBoxChanged(int idx)
{
    ...
    // }
    for (int i = qcp->graphCount() - 1; i >= 0; --i)
    {
        qcp->removeGraph(qcp->graph(i));
    }
    qcp->clearPlottables();
    qcp->clearGraphs();
    ...
    {
    case 0:
        setupQuadraticDemo(qcp);
        break;
    case 1:
        setupSimpleDemo(qcp);
        break;
    case 2:
        setupSincScatterDemo(qcp);
        break;
    case 3:
        setupScatterStyleDemo(qcp);
        break;
    case 4:
        setupLineStyleDemo(qcp);
        break;
    case 5:
        setupScatterPixmapDemo(qcp);
        break;
    case 6:
        setupDateDemo(qcp);
        break;
    case 7:
        setupTextureBrushDemo(qcp);
        break;
    case 8:
        setupMultiAxisDemo(qcp);
        break;
    case 9:
        setupLogarithmicDemo(qcp);
        break;
    case 10:
        setupRealtimeDataDemo(qcp);
        break;
    case 11:
        setupParametricCurveDemo(qcp);
        break;
    case 12:
        setupBarChartDemo(qcp);
        break;
    case 13:
        setupStatisticalDemo(qcp);
        break;
    case 14:
        setupSimpleItemDemo(qcp);
        break;
    case 15:
        setupItemDemo(qcp);
        break;
    case 16:
        ...
        break;
    case 17:
        setupAdvancedAxesDemo(qcp);
        break;
    case 18:
        setupColorMapDemo(qcp);
        break;
    case 19:
        setupFinancialDemo(qcp);
        break;
    case 20:
        setupPolarPlotDemo(qcp);
        break;
    case 21:
        interactWaferMap(qcp);
        break;
    case 22:
        overlapWaferMapAndContour(qcp);
        break;
